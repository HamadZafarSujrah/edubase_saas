<div class="container-fluid pb-5">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4 p-3 bg-white rounded-3 shadow-sm">
        <div>
            <h5 class="mb-0 fw-bold text-dark"><i class="fas fa-id-card me-2 text-primary"></i> Roll No. Slips</h5>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 small mt-1">
                    <li class="breadcrumb-item"><a href="/dashboard" class="text-decoration-none">Home</a></li>
                    <li class="breadcrumb-item active">Roll No. Slips</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="card border-0 shadow-sm rounded-4">
        <div class="card-body p-4">
            <div class="row g-3 align-items-end">
                ...
                <div class="col-md-3">
                    <a href="{{ route('print-roll-no-slips', ['campus_id' => $campus_id, 'school_class_id' => $school_class_id, 'section_id' => $section_id]) }}"
                       target="_blank"
                       class="btn btn-primary fw-bold px-5 py-2 rounded-3 shadow-sm w-100 {{ !$section_id ? 'disabled' : '' }}"
                       @if(!$section_id) tabindex="-1" aria-disabled="true" onclick="return false;" @endif>
                        <i class="fas fa-print me-2"></i> Print Slips
                    </a>
                </div>
            </div>
        </div>
