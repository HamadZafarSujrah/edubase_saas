<div class="container-fluid pb-5">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4 p-3 bg-white rounded-3 shadow-sm">
        ...
        <div class="btn-group">
            ...
            <a href="/manage-students" class="btn btn-primary btn-sm px-3"><i class="fas fa-list me-1"></i> Student Directory</a>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-xl-9 col-lg-8">
            ...
            <!-- 3. PREVIOUS QUALIFICATION GRID (New Level Feature) -->
