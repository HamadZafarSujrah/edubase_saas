<div>
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="h3 mb-0 text-gray-800"><i class="fas fa-medal me-2 text-primary"></i> Academic Standings</h2>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td colspan="3" class="text-center py-5 text-muted">
                                ...
                                <p>E.g. Pass, Fail, Distinction, Promoted.</p>
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
        ...
        <div class="modal-content border-0 shadow">
          ...
          <div class="modal-body p-4">
              <div class="mb-3">
                  ...
                  <input type="text" class="form-control form-control-lg bg-light" wire:model="name" placeholder="E.g. Distinction">
