<div>
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="h3 mb-0 text-gray-800"><i class="fas fa-clock me-2 text-primary"></i> Class Shifts</h2>
                ...
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><span class="badge bg-info fw-bold">{{ $shift->school_classes_count }}</span></td>
        ...
        <div class="modal-content border-0 shadow">
          ...
          <div class="modal-body p-4">
              <div class="mb-3">
                  ...
                  <input type="text" class="form-control bg-light" wire:model="name" placeholder="E.g. Morning Shift">
